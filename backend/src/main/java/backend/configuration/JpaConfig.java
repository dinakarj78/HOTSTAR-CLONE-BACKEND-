...
public class JpaConfig {
   ...
   public LocalContainerEntityManagerFactoryBean entityFactory() {
     ...
     /* emf.setPackagesToScan("io.dillu.rest.Rest.EmployeeEntity");*/
      JpaVendorAdapter adapter=new HibernateJpaVendorAdapter();
      emf.setJpaVendorAdapter(adapter);
      System.out.println("HIHIHHIHIH");
      emf.setJpaProperties(properties()); 
      emf.setPackagesToScan("io.egen.hotstarClone.Entities");
      return emf; 
}
   @Bean
  ...
  JpaTransactionManager txm=new JpaTransactionManager(emf);
   ...
   public DataSource dataSource() {
       ...
       ds.setUrl("jdbc:mysql://127.0.0.1:3306/hotstardb");
   ...
   private Properties properties() {
   	...
   	props.setProperty("hibernate.hbm2ddl.auto","org.hibernate.dialect.MySQLDialect");
